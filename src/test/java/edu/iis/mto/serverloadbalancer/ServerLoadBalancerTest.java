...
import static edu.iis.mto.serverloadbalancer.ServerVmsCountMatrcher.hasAVmsCountOf;
...
public class ServerLoadBalancerTest {
	...
	@Test public void balancingServerWithNoVms_serverStaysEmpty(){
		...
		balancing(aServersListWith(theServer), asEmptyListOfVms());
	...
	@Test public void balancingServerAndVms(){
